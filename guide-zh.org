...
| [[https://github.com/emacs-helm/helm][helm]]                | 自动完成的框架,在其上有很多插件完成具体功能       | ido              |
| [[http://www.emacswiki.org/emacs/InteractivelyDoThings][ido]]                 | 和 helm 类似,我是 helm 和 ido 同时用              | helm             |
| [[https://github.com/mooz/js2-mode][js2-mode]]            | javascript的major-mode,自带 javascript 语法解释器 | js-mode          |
...
我[[https://github.com/search?o=desc&q=emacs&ref=searchresults&s=stars&type=Repositories&utf8=%E2%9C%93][搜了下github]], 这是首页的结果:
