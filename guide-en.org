...
Please use above URL to contact me instead of send my email for your own good. Because the github's issue tracker will also send me email which is always in the folder with highest priority.

Emacs is actually more a community than a static software. Cool geeks keep popping up in this community. So I will keep updating this article to notify you the latest information of Emacs community.
