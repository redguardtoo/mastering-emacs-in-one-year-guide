...
In order to get the most benefit of sharing, you need make sure your setup is qualified to share publicly. I hate those guys who hardcode their family names like "/home/john/.emacs.d/" into their setup. Unless I happen to be John, I have to waste my time to remove all those stupid names. I suggest ignore any setup with hardcoded things. There are plenty of superiors at github.
*** Dropbox
