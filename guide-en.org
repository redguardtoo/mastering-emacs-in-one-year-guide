...
- The key point is not to re-invent the wheel
...
*** Emacs makes you good at every other editor
If you master the best editor in the world, you will figure out the best pratices automatically on other text editors.

For example, based on my Emacs knowledge, I assume a qualified text editor:
- Should have a inbuilt package manager
- Its broken 3rd party plugin could be [[http://www.gnu.org/software/emacs/manual/html_node/elisp/Advising-Functions.html][fixed]] by plugin user without bugging the plugin developer
- When remote repository is down, [[https://github.com/redguardtoo/myelpa][a local repository]] could be created in the memory stick [[https://github.com/redguardtoo/elpa-mirror][in one minute]].
...
** Attitude
I usually suggest my readers being open minded. But some readers are confused because they are already open minded *enough*.

So I'd better be very blunt in this section,
- It's critical to *truly* understand [[https://www.gnu.org/philosophy/free-sw.en.html][meaning of software freedom]]. Listening Richard Stallman's interviews 20 times is a good start for true understanding.
