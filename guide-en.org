...
*** Reddit
The average quality of discussion on [[https://www.reddit.com/r/emacs/][Reddit]] is better. The advantage of Reddit is that it's usually NOT blocked by the corporate firewall.
*** git cloud services
[[https://github.com][GitHub]], [[https://gitlab.com][GitLab]] and [[https://bitbucket.org][Bitbucket]] are social networks for developers.
...
*** IRC
Join the #emacs and/or #emacs-beginners channels on [[https://webchat.freenode.net/][freenode]] for questions and discussions.
* Readings
** EmacsWiki
