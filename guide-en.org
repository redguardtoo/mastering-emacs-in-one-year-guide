...
Sometimes bad things happen. The remote repository could be shut down. Emacs guy expects she can [[https://github.com/redguardtoo/myelpa][create her own repository on my USB drive]] [[https://github.com/redguardtoo/elpa-mirror][in one minute]].
...
BTW, I encourage you to try other text editors after one year if you want to help unbelievers to understand the definition of the master.
...
That's actually great. I'm lucky to pick up his setup and stick to it. Simply pulling from his git branch gets me updated with the latest cooling thing in community.
...
There is huge difference between efficient and easy. For example, a setup using Vim key bindings is absolutely NOT easy for newbie but definitely efficient.
...
When I learned Emacs way, I could not endure the default key bindings of my browser Firefox. So I installed a Firefox addon [[https://github.com/mooz/keysnail/wiki][Keysnail]] to convert Firefox into Emacs. That basically double my speed on browser navigation. I am doing web development these days. Browser navigation is my daily job.

Since I already know *the way*. I immediately realized that Keysnail is awesome because [[https://github.com/mooz][its developer mooz]] is awesome. I wanted to follow him and used whatever he used. Then I found his [[https://github.com/mooz/percol][percol]] which made all my operations under Bash shell ten times faster (git, [[http://blog.binchen.org/posts/how-to-do-the-file-navigation-efficiently.html][file navigation]], database management ...).

When I know *the way*, things used to be important to me now becomes trivial. For example, the question which text editor has better file browser does not matter to me at all. Why should I use any file explorer if I can do it ten times faster in shell?

I'm also more willing to share for selfish reasons. For example, some colleague asked me to share my file navigation snippet. I gave away the snippet without hesitation. If he regard technology as black magic and sharing knowledge makes him weak, then he have already lose in the competition. Because we are living in the world of science and engineering, I *better myself more quickly by sharing to the best, by learning from the best everyday*. He will still do me good by regarding knowledge sharing as a favor of sharing magic power, by doing QA of my snippet as a user.
** FAQ
...
Use [[https://github.com/redguardtoo/emacs.d][my setup]].
...
Try to understand master's setup. Don't make judgment too early. It's easy to make judgment. But understanding needs wisdom and hard work.
...
If I cannot win, the only strategy is to join him, that's why I clone his setup and start to report bug for him. Here is [[https://github.com/purcell/emacs.d/issues/6][first issue I reported]]. Besides, reporting bugs also gives you the opportunity to talk with the master.

So don't run away from the masters' huge setup. Regard it as a challenge to improve yourself.
...
That's why I stress that you need avoid tweaking Emacs and copy the master's setup. Try to use Emacs asap.
...
Please don't ask me basic questions since I've already shown you how to find answer.
** Summary
