...
When people say IDE is good for programming. They are usually talking about code navigation, code completion and real time documetation lookup.
...
How good you will be at Emacs (or anything?) is determined by your attitude,

Two points to be successful (mastering Emacs in one year):
1. open minded
