...
**** Reddit
[[http://www.reddit.com/r/emacs/][Reddit]] is as good as Google plus. The advantage of Reddit is that it's seldom blocked by the corporate firewall.
**** Github
...
** Take action
I admit that all roads lead to Rome. So it doesn't matter which road you choose. What matters is walking on the road right now. 
...
- Find all the people behind the list of Emacs plugins
...
One developer has problem to sort a big dictionary file with *pure* Emacs Lisp. It's too slow.

After consulting me, he found that the [[https://github.com/tumashu/chinese-pyim/commit/90519d3f][GNU Sort is much better]] in this case.
