...
Not must-have addons. There are many other alternative which are as good as the listed.

My purpose here is to solve help new guys on two problems on choose plugins:
