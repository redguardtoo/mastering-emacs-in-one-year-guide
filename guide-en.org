...
If you have studied any guru's set up, you will find that she use "smex" to remember the frequently used command, as it is often more efficient than pressing hot keys. So masters don't remember key bindings intentionally.
...
- If you can report a bug about master's set up, at least in that moment, you have proven you are better at a certain issue than the master.
- You will get guidance from master when she analyzes your bug report.
...
For example, people reported that I mixed some personal stuff (my personal email, full path of my hobby project) into my set up which they need remove before usage. They expect my set up usable out of the box.
