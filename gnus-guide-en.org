...
** Usage
After starting Gnus by =M-x gnus=, you come to the "Group Buffer". The "Group Buffer" lists the mail folders. In Gnus, the folder is called "Group". Please the folders are *invisible* in Group Buffer by default!
