...
You may think [[http://www.google.com/inbox/][Google's Inbox]] is dfferent. Trust me, it's not worth your time. You only need Popfile!

Popfile is open sourced. The data is stored *locally* with my full control. For example, popfile still works when I switch the mail server.

For example, after being trained by your Gmail date, Popfile becomes *smarter*. You can switch the smarter Popfile into your office's Exchange Mail Server. Popfile will *classify your work mails* properly.

I'm 99% sure this solution will work because I've been using it for a very long time. I take pity on my colleagues who know only Outlooks.
