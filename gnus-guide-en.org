...
Gnus will track your sent emails *by Gnus* in your local folder. If you are use Gmails' SMTP server, Gmail will also back up the mails in "[Gmail]/Sent Mail" folder at Google's *remote* server.

If you subscribe that folder with Gnus, you can always manage *all* your sent mails.
